    ...
    public void run(String... args) throws Exception {
        ...
        seedCategoryWithProducts("Shirts", List.of(
            new SeedProduct("Classic White Oxford Shirt", "Polo Ralph",
                ...
                1899.00, 50, "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500"),
            new SeedProduct("Casual Linen Summer Shirt", "Tommy Hilfiger",
                ...
                2499.00, 35, "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?w=500"),
            new SeedProduct("Slim Fit Chambray Denim Shirt", "Levi's",
                ...
                1699.00, 40, "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=500")
        ));
        ...
        seedCategoryWithProducts("Pants", List.of(
            new SeedProduct("Slim Fit Stretch Chino Pants", "Dockers",
                ...
                2199.00, 45, "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=500"),
            new SeedProduct("Classic 501 Original Fit Jeans", "Levi's",
                ...
                3499.00, 60, "https://images.unsplash.com/photo-1542272604-787c3835535d?w=500"),
            new SeedProduct("Relaxed Lightweight Cargo Pants", "Columbia",
                ...
                2799.00, 30, "https://images.unsplash.com/photo-1517423738875-5ce310acd3da?w=500")
        ));
        ...
        seedCategoryWithProducts("Accessories", List.of(
            new SeedProduct("Minimalist Leather Cardholder Wallet", "Bellroy",
                ...
                1299.00, 80, "https://images.unsplash.com/photo-1627124712838-1a2a7dec33c4?w=500"),
            new SeedProduct("Classic Aviator Sunglasses", "Ray-Ban",
                ...
                5999.00, 25, "https://images.unsplash.com/photo-1513909590959-157960e7eec6?w=500"),
            new SeedProduct("Water-Resistant Commuter Backpack", "Herschel",
                ...
                3999.00, 40, "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500")
        ));
        ...
        seedCategoryWithProducts("Mobiles", List.of(
            new SeedProduct("iPhone 15 Pro Max", "Apple",
                ...
                139999.00, 15, "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=500"),
            new SeedProduct("Galaxy S24 Ultra", "Samsung",
                ...
                124999.00, 20, "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=500"),
            new SeedProduct("Pixel 8 Pro", "Google",
                ...
                99999.00, 25, "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=500")
        ));
        ...
        seedCategoryWithProducts("Mobile Accessories", List.of(
            new SeedProduct("Magnetic Wireless Power Bank", "Anker",
                ...
                2999.00, 90, "https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=500"),
            new SeedProduct("Hybrid Shockproof Phone Case", "Spigen",
                ...
                899.00, 150, "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=500"),
            new SeedProduct("Dual USB-C 40W Fast Charger", "Anker",
                ...
                1499.00, 120, "https://images.unsplash.com/photo-1622445262465-2481c4574875?w=500")
        ));
        ...
        seedCategoryWithProducts("Beauty", List.of(
            new SeedProduct("Hydrating Hyaluronic Acid Serum", "The Ordinary",
                ...
                699.00, 200, "https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?w=500"),
            new SeedProduct("Matte Liquid Lipstick Set", "M.A.C",
                ...
                2190.00, 85, "https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=500"),
            new SeedProduct("Mineral Sunscreen SPF 50", "La Roche-Posay",
                ...
                1850.00, 70, "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=500")
        ));
        ...
        seedCategoryWithProducts("Appliances", List.of(
            new SeedProduct("Digital Air Fryer 4L", "Philips",
                ...
                7999.00, 40, "https://images.unsplash.com/photo-1621972750749-0fbb1abb7736?w=500"),
            new SeedProduct("Robotic Vacuum Cleaner", "Xiaomi",
                ...
                19999.00, 18, "https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=500"),
            new SeedProduct("Programmable Espresso Machine", "DeLonghi",
                ...
                14999.00, 15, "https://images.unsplash.com/photo-1579888944880-d98341148721?w=500")
        ));
        ...
        seedCategoryWithProducts("Books", List.of(
            new SeedProduct("Atomic Habits", "James Clear",
                ...
                499.00, 300, "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=500"),
            new SeedProduct("The Psychology of Money", "Morgan Housel",
                ...
                399.00, 250, "https://images.unsplash.com/photo-1592496431122-2349e0fbc666?w=500"),
            new SeedProduct("Sapiens: A Brief History of Humankind", "Yuval Noah Harari",
                ...
                599.00, 180, "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=500")
        ));
        ...
        seedCategoryWithProducts("Food", List.of(
            new SeedProduct("Organic Roasted Almonds", "Nutty Gritties",
                ...
                449.00, 150, "https://images.unsplash.com/photo-1508061253366-f7da158b6d4f?w=500"),
            new SeedProduct("Pure Matcha Green Tea Powder", "Organica",
                ...
                999.00, 90, "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=500"),
